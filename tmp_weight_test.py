# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 15:33:27 2024
...
test_id=['Hydrogen_REF_1period_36day',
         #'Hydrogen_REF_1period_24day_weight_equal',
         'Hydrogen_REF_1period_24day_weight_starting',
         'Hydrogen_REF_1period_24day_weight_output',
         #'Hydrogen_400ppm_1period_36day',
         #'Hydrogen_400ppm_1period_36day_half_tmp_weight'
         ]
...
capacity.plot.bar(ax=ax1,
                  stacked=True,
                  color=capacity_color,
                  legend=False)

generation.plot.bar(ax=ax2,
                    stacked=True,
                    color=color,
                    legend=False)

generation_H2.plot.bar(ax=ax3,
              stacked=True,
              color=H2_color,
              legend=False)

unitcost.plot.bar(ax=ax4,
                  stacked=True,
                  color=color,
                  legend=False)
...
ax2.set_ylabel('TWh')
ax2.set_xlabel('')
ax2.set_ylim([-6000,20000])
ax2.yaxis.set_major_formatter(StrMethodFormatter('{x:,.0f}'))

ax3.set_ylabel('TWh')
ax3.set_xlabel('')
ax3.set_ylim([-2500,2500])
ax3.set_xticklabels(['REF','REF + $H_{2}$','90R','90R + $H_{2}$','ZE','ZE + $H_{2}$'])
ax3.yaxis.set_major_locator(ticker.MultipleLocator(2500))
#ax.yaxis.set_minor_locator(ticker.MultipleLocator(1))

ax4.set_ylabel('$/MWh')
ax4.set_xlabel('')
ax4.set_xticklabels(['REF','REF + $H_{2}$', '90R','90R + $H_{2}$','ZE','ZE + $H_{2}$'])
...
fig.text(0.0,0.5,'c', fontweight="bold")
fig.text(0.5,0.5,'d', fontweight="bold")
