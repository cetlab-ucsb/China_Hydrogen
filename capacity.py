...
test_id=['REF_1period_36day',
         ...
         '700ppm_1period_36day',
         'Hydrogen_700ppm_1period_36day',
         '550ppm_1period_36day',
         'Hydrogen_550ppm_1period_36day',
...
ax5.set_xticklabels(['REF w/o $H_{2}$','REF','80R w/o $H_{2}$','80R','90R w/o $H_{2}$','90R','ZE w/o $H_{2}$','ZE'])


ax6.set_ylabel('$/MWh')
ax6.set_xlabel('')
ax6.set_xticklabels(['REF w/o $H_{2}$','REF','80R w/o $H_{2}$','80R','90R w/o $H_{2}$','90R','ZE w/o $H_{2}$','ZE'])
...
fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/' + 'Fig1' + '.png', dpi=300, bbox_inches='tight')
