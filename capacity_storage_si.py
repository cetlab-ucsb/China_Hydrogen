...
test_id=[
        ...
        'Hydrogen_400ppm_1period_36day',
         'Hydrogen_400ppm_1period_36day_constraint',
         'Hydrogen_400ppm_1period_36day_constraint_25',
...
scenario_order = ['400ppm_1period_36day',
                  'Hydrogen_400ppm_1period_36day',
                  'Hydrogen_400ppm_1period_36day_constraint',
                  'Hydrogen_400ppm_1period_36day_constraint_25',
                  'Hydrogen_400ppm_1period_36day_tank'
...
unitcost = unitcost.loc[scenario_order,]
#%%
...
ax.set_ylabel('$/MWh')
ax.set_xlabel('')
ax.set_xticklabels(['ZE w/o $H_{2}$','ZE', 'ZE + 50% undergound storage','ZE + 25% undergound storage', 'ZE + 0% undergound storage'])
...
fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/revision/' + 'Fig_storage' + '.png', dpi=300, bbox_inches='tight')
