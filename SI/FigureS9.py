...
label=['Coal','Gas','Hydropower','Nuclear',
       'Offshore wind', 'Onshore wind', 'Solar', 'Battery', 'Pumped hydro', 'Electrolyzer + Liquified', 'Hydrogen combustion turbine','Fuel cell',
       'Underground storage', 'Tank',
       'Electricity grid','Hydrogen pipeline']

#%%
unitcost.loc['Hydrogen_NH3',:] = unitcost.loc['Hydrogen_400ppm_1period_36day',:]
unitcost.loc['Hydrogen_NH3', 'Electrolyzer'] = unitcost.loc['Hydrogen_400ppm_1period_36day','Electrolyzer'] *3
unitcost.loc['Hydrogen_NH3', 'Tank'] = unitcost.loc['Hydrogen_400ppm_1period_36day','Salt_cavern'] *2/3
unitcost.loc['Hydrogen_NH3', 'Salt_cavern'] = 0
unitcost.loc['Hydrogen_NH3', 'Pipeline'] = unitcost.loc['Hydrogen_400ppm_1period_36day','Pipeline'] *1/3
...
ax.set_ylabel('$/MWh')
ax.set_xlabel('')
ax.set_xticklabels(['ZE w/o $H_{2}$', 'ZE', 'ZE w/o undergound storage', 'ZE + Ammonia'])
...
fig.savefig('/Users/hy4174/Documents/Hydrogen/' + 'Fig_NH3' + '.png', dpi=300, bbox_inches='tight')
