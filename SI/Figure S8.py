...
test_id=[
         ...
         'Hydrogen_400ppm_1period_36day_H2_expand_constraint',
         'Hydrogen_400ppm_1period_36day_H2_expand_flat_constraint',
         'Hydrogen_400ppm_1period_36day_H2_expand_constraint_25',
         'Hydrogen_400ppm_1period_36day_H2_expand_flat_constraint_25',
...
ax.set_yticklabels([
                    ...
                    'ZE+ $H_{2}$ demand\n + electricity following demand\n + 25% underground storage',
                    'ZE+ $H_{2}$ demand\n + 50% underground storage',
                    'ZE+ $H_{2}$ demand\n + electricity following demand\n + 50% underground storage',
                    'ZE+ $H_{2}$ demand\n',
                    'ZE+ $H_{2}$ demand\n + electricity following demand',
                   ],
...
plt.show()
#%%
fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/revision/' + 'FigS4' + '.png', dpi=300, bbox_inches='tight')
