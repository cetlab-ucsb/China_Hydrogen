...
test_id=[
         ...
         'Hydrogen_400ppm_1period_36day_H2_expand_decouple_flat_tank',
         'Hydrogen_400ppm_1period_36day_H2_expand_flat_tank',
...
ax.set_yticklabels([
                    ...
                    'ZE+ $H_{2}$ demand\n + decouple + no underground storage',
                    'ZE+ $H_{2}$ demand',
                    'ZE+ $H_{2}$ demand\n + decouple',           
                   ],
                   fontsize=14)
...
plt.show()
#%%
fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/revision/' + 'FigS4_couple' + '.png', dpi=300, bbox_inches='tight')
