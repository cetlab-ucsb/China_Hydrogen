...
test_id=[
         ...
         'Hydrogen_400ppm_1period_36day_ccs_storage_50',
...
ax5.set_xticklabels(['ZE', 'ZE + CCS + DAC','ZE + low CCS + DAC', 'ZE + Nuclear'])

ax6.set_ylabel('$/MWh')
ax6.set_xlabel('')
ax6.set_xticklabels(['ZE', 'ZE + CCS + DAC','ZE + low CCS + DAC', 'ZE + Nuclear'])
...
#%%
fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/' + 'Fig3' + '.png', dpi=300, bbox_inches='tight')
