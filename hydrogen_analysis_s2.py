...
test_id=[
         ...
         'Hydrogen_400ppm_1period_36day_H2_expand_decouple',
         ...
         'Hydrogen_400ppm_1period_36day_H2_expand_SMR_ccs_conservative'
         ]
...
couple='Hydrogen_400ppm_1period_36day_H2_expand_SMR_ccs_conservative',
...
ax4.legend([handles1[0],handles1[1]],['Electricity','Non-electricity'],frameon=False)
...
cbar_ax = fig.add_axes([0.98, 0.125, 0.015, 0.2])
...
fig.legend(reversed(handles[4:7]), reversed(label[4:7]),
           ...
           loc='center left', bbox_to_anchor=(0.98, 0.47),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[7:9]), reversed(label[7:9]),
           title='Conventional storage',
           loc='center left', bbox_to_anchor=(0.98, 0.53),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[9]), [label[9]],
           title='Power to gas',
           loc='center left', bbox_to_anchor=(0.98, 0.57),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[10:12]), reversed(label[10:12]),
           title='Gas to power',
           loc='center left', bbox_to_anchor=(0.98, 0.62),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[12:14]), reversed(label[12:14]),
           title='Fossil fuel-baesed hydrogen',
...
fig.legend(reversed(handles[14:16]), reversed(label[14:16]),
           ...
           loc='center left', bbox_to_anchor=(0.98, 0.72),
           frameon=False
           )._legend_box.align = "left"
...
fig.legend(reversed(handles[19:]), reversed(label[19:]),
           ...
           loc='center left', bbox_to_anchor=(0.98, 0.86),
           frameon=False
           )._legend_box.align = "left"
...
line3 = plt.plot([],[], color='r') 
# Create another legend for the second line.
fig.legend(handles=line3,
           labels=[''],
...
fig.legend(handles=[line1,line2],labels=['moderate','uncertainty'], 
           loc='center left',
           title='Levelized cost of green hydrogen $/kg',
...
ax5.set_ylabel('$/kW/yr',fontsize=14)
ax5.set_xlabel('Natural gas \n $/mmBtu',fontsize=14)
ax6.set_xlabel('Coal \n $/mmBtu',fontsize=14)
...
#%%
fig.savefig('H:/Hydrogen/Figure/' + 'Fig4' + '.png', dpi=300, bbox_inches='tight')
