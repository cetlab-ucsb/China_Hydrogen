...
generation_capacity.loc[scenario_id,].plot.bar(ax=ax1,
                  stacked=True,
                  color=capacity_color,
                  legend=False)

transmission_capacity.loc[scenario_id,].plot.bar(ax=ax2,
                  stacked=True,
                  color=transmission_color,
                  legend=False)

storage_capacity.loc[scenario_id,].plot.bar(ax=ax3,
                  stacked=True,
                  color=storage_capacity_color,
                  legend=False)
ax3.axhline(0,color='black',linewidth=1)

capacity_energy.loc[scenario_id,].plot.bar(ax=ax4,
              stacked=True,
              color=energy_color,
              legend=False)
...
generation.loc[scenario_id,].plot.bar(ax=ax5,
                    stacked=True,
                    color=color,
                    legend=False)


unitcost.loc[scenario_id,].plot.bar(ax=ax6,
                  stacked=True,
                  color=color,
                  legend=False)
...
fig.legend(reversed(handles[0:2]), reversed(label[0:2]),
           title='Conventional energy',
           loc='center left', bbox_to_anchor=(0.98, 0.1),frameon=False
           )._legend_box.align = "left"


fig.legend(reversed(handles[2:5]), reversed(label[2:5]),
           title='Renewable energy',
           loc='center left', bbox_to_anchor=(0.98, 0.26),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[5:7]), reversed(label[5:7]),
           title='Conventional storage',
           loc='center left', bbox_to_anchor=(0.98, 0.4),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[8]), [label[7]],
           title='Power to gas',
           loc='center left', bbox_to_anchor=(0.98, 0.5),frameon=False
           )._legend_box.align = "left"

fig.legend(reversed(handles[8:10]), reversed(label[8:10]),
           title='Gas to power',
           loc='center left', bbox_to_anchor=(0.98, 0.6),frameon=False
           )._legend_box.align = "left"
...
fig.legend(reversed(handles[12:14]), reversed(label[12:14]),
           title='Transmission',
           loc='center left', bbox_to_anchor=(0.98, 0.84),
           frameon=False
           )._legend_box.align = "left"
...
ax3.set_yticklabels(['Charge','1500','0','1500','Discharge'])
...
ax5.set_ylabel('TWh')
ax5.set_xlabel('')
ax5.set_ylim([-1000,16000])
ax5.set_xticklabels(['ZE hourly', 'ZE representative'])


ax6.set_ylabel('$/MWh')
ax6.set_xlabel('')
ax6.set_xticklabels(['ZE hourly','ZE representative'])
...
plt.show()
#fig.savefig('/Users/hy4174/Documents/Hydrogen/Figure/' + 'Fig_S_temporal' + '.png', dpi=300, bbox_inches='tight')
